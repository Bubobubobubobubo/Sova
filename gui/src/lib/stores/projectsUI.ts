...
export const statusMessage = derived(projectsUIState, ($state) => $state.statusMessage);
export const searchQuery = derived(projectsUIState, ($state) => $state.searchQuery);
export const sortField = derived(projectsUIState, ($state) => $state.sortField);
export const sortDirection = derived(projectsUIState, ($state) => $state.sortDirection);
export const editingName = derived(projectsUIState, ($state) => $state.editingName);
